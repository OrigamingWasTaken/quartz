...
const TagContent: QuartzComponent = (props: QuartzComponentProps) => {
	...
	if (tag === '/') {
		const tags = [...new Set(allFiles.flatMap((data) => data.frontmatter?.tags ?? []).flatMap(getAllSegmentPrefixes))].sort(
								...
								<div class="page-listing">
									<p>
										...
										{pages.length > numPages && (
											<>
												{' '}
												<span>{i18n(cfg.locale).pages.tagContent.showingFirst({ count: numPages })}</span>
											</>
										)}
									</p>
